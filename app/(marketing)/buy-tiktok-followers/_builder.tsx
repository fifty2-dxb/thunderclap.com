...
const PACKAGES = [
  { qty: 100, price: 4.79, regular: 5.99 },
  { qty: 200, price: 7.89, regular: 9.86 },
  { qty: 500, price: 16.79, regular: 20.99 },
  { qty: 750, price: 21.99, regular: 27.49 },
  { qty: 1000, price: 25.99, regular: 32.49 },
  { qty: 2000, price: 34.99, regular: 43.74, popular: true },
  { qty: 2500, price: 38.99, regular: 48.74 },
  { qty: 5000, price: 58.99, regular: 73.74 },
  { qty: 10000, price: 98.99, regular: 123.74 },
  { qty: 20000, price: 157.99, regular: 197.49 },
  { qty: 50000, price: 349.99, regular: 437.49 },
] as const;

const SIDE_BENEFITS = [
  { title: "Real accounts", desc: "followers from real, active TikTok users" },
...
export function TikTokFollowersHero() {
  ...
  const checkoutHref = `/checkout?platform=tiktok&service=followers&qty=${pkg.qty}&price=${pkg.price}&premium=${premium ? 1 : 0}`;
    ...
    <section style={{ background: "var(--uv-bg-lavender)", paddingTop: 40, paddingBottom: 96 }}>
      <div className="container">
        ...
        >
          ...
          <a href="/buy-tiktok-followers" style={{ color: "var(--uv-fg-3)" }}>
            TikTok
          </a>
          <span style={{ opacity: 0.4 }}>›</span>
        ...
        >
          Buy TikTok Followers <span style={{ color: "var(--uv-fg-3)", fontWeight: 500 }}>—</span>{" "}
          <span className="grad-text">that unlock the FYP</span>
        </h1>
        <p
          style={{
            fontSize: 17,
        ...
        >
          Buy TikTok Followers from real, active accounts. 30-day refill guarantee, no password
        ...
        <div className="live-pill">
          ...
          <span>
            <strong>527 live users</strong> on this page right now
          </span>
        </div>
          ...
          <div className="svc-builder">
            ...
            <div className="pkg-card">
              ...
              <label className="pkg-url-wrap">
                ...
                <div style={{ flex: 1 }}>
                  <div className="pkg-url-label">TIKTOK USERNAME</div>
                  <input
...
export function TikTokFollowersFaq() {
