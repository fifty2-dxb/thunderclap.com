...
const PACKAGES = [
  { qty: 50, price: 0.99, save: 0 },
  { qty: 100, price: 1.49, save: 0 },
  { qty: 250, price: 3.49, save: 0 },
  { qty: 500, price: 6.49, save: 0 },
  { qty: 1000, price: 11.99, save: 20 },
  { qty: 2500, price: 26.99, save: 28, popular: true },
  { qty: 5000, price: 49.99, save: 33 },
  { qty: 10000, price: 89.99, save: 40 },
  { qty: 25000, price: 199.99, save: 45 },
  { qty: 50000, price: 349.99, save: 48 },
  { qty: 100000, price: 599.99, save: 50 },
  { qty: 250000, price: 1299.99, save: 52 },
  { qty: 500000, price: 2299.99, save: 54 },
  { qty: 1000000, price: 3999.99, save: 55 },
] as const;

const SIDE_BENEFITS = [
  { title: "Real users", desc: "reposts from real, active Twitter / X accounts" },
...
export function TwitterRetweetsHero() {
  ...
  const checkoutHref = `/checkout?platform=twitter&service=retweets&qty=${pkg.qty}&price=${pkg.price}&premium=${premium ? 1 : 0}`;
    ...
    <section style={{ background: "var(--uv-bg-lavender)", paddingTop: 40, paddingBottom: 96 }}>
      <div className="container">
        ...
        >
          ...
          <a href="/buy-twitter-followers" style={{ color: "var(--uv-fg-3)" }}>
            Twitter / X
          </a>
          <span style={{ opacity: 0.4 }}>›</span>
          <span style={{ color: "var(--uv-fg-1)", fontWeight: 600 }}>Retweets</span>
        </nav>
        ...
        >
          Buy Twitter Retweets <span style={{ color: "var(--uv-fg-3)", fontWeight: 500 }}>—</span>{" "}
          <span className="grad-text">that snap the For You algorithm awake</span>
        </h1>
        <p
          style={{
            fontSize: 17,
        ...
        >
          Buy Twitter / X Retweets (reposts) from real, active users. Money-back guarantee, no
          password needed, drip-fed naturally for a safe, organic amplification curve.
        </p>
        ...
        <div className="svc-layout">
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                ...
                <div>
                  ...
                  <div className="prem-sub">
                    High-follower reposters · faster delivery · lifetime refill
                  </div>
                </div>
              </div>
              <button
          ...
          <aside className="svc-side">
            ...
            <div className="side-summary">
              <span className="side-tw-icon">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231 5.45-6.231zM17.083 19.77h1.833L7.084 4.126H5.117L17.083 19.77z" fill="#fff"/>
                </svg>
              </span>
              <div>
                ...
                <div className="side-sum-sub">
                  Twitter / X · {premium ? "Premium" : "Standard"}
                </div>
              </div>
...
export function TwitterRetweetsFaq() {
    ...
    <section style={{ padding: "32px 0 80px" }}>
      <div className="container-narrow">
        ...
        <div className="faq-chips">
          {Array.from({ length: Math.ceil(TW_FAQS.length / 2) }).map((_, row) => {
            const lIdx = row * 2;
            const rIdx = row * 2 + 1;
            const l = TW_FAQS[lIdx];
            const r = TW_FAQS[rIdx];
