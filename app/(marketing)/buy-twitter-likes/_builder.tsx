...
const PACKAGES = [
  ...
  { qty: 250, price: 2.99, save: 0 },
  { qty: 500, price: 5.49, save: 0 },
  { qty: 1000, price: 9.99, save: 0 },
  { qty: 2500, price: 22.99, save: 25, popular: true },
  { qty: 5000, price: 42.99, save: 28 },
  { qty: 10000, price: 79.99, save: 32 },
  { qty: 25000, price: 179.99, save: 38 },
  { qty: 50000, price: 329.99, save: 42 },
  { qty: 100000, price: 599.99, save: 45 },
  { qty: 250000, price: 1399.99, save: 48 },
  { qty: 500000, price: 2599.99, save: 50 },
  { qty: 1000000, price: 4799.99, save: 50 },
] as const;

const SIDE_BENEFITS = [
  { title: "Real users", desc: "likes from real, active Twitter / X accounts" },
...
export function TwitterLikesHero() {
  ...
  return (
    <section style={{ background: "var(--uv-bg-lavender)", paddingTop: 40, paddingBottom: 96 }}>
      <div className="container">
        ...
        >
          Buy Twitter Likes <span style={{ color: "var(--uv-fg-3)", fontWeight: 500 }}>—</span>{" "}
          <span className="grad-text">that push your tweet into the For You feed</span>
        </h1>
        <p
          style={{
            fontSize: 17,
        ...
        >
          Buy Twitter / X Likes from real, active accounts. Money-back guarantee, no password
          needed, drip-fed naturally for a safe, organic look.
        </p>
          ...
          <div className="svc-builder">
            ...
            <div className="pkg-card">
              ...
              <label className="pkg-url-wrap">
                ...
                <div style={{ flex: 1 }}>
                  <div className="pkg-url-label">@HANDLE OR TWEET LINK</div>
                  <input
...
export function TwitterLikesFaq() {
