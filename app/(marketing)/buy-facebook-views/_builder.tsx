...
const PACKAGES = [
  { qty: 500, price: 0.79, save: 0 },
  { qty: 1000, price: 1.49, save: 0 },
  { qty: 2500, price: 3.49, save: 0 },
  { qty: 5000, price: 6.49, save: 0 },
  { qty: 10000, price: 11.99, save: 20, popular: true },
  { qty: 25000, price: 27.99, save: 25 },
  { qty: 50000, price: 49.99, save: 30 },
  { qty: 100000, price: 89.99, save: 35 },
  { qty: 250000, price: 199.99, save: 38 },
  { qty: 500000, price: 349.99, save: 42 },
  { qty: 1000000, price: 599.99, save: 45 },
  { qty: 2500000, price: 1299.99, save: 48 },
  { qty: 5000000, price: 2399.99, save: 50 },
  { qty: 10000000, price: 4499.99, save: 50 },
] as const;

const SIDE_BENEFITS = [
  { title: "Real watch time", desc: "views from real Facebook users, not bots" },
  { title: "Starts in 5 min", desc: "drip-fed over 1-6 hours for an organic curve" },
  { title: "Money-back", desc: "refund if we miss the count or speed" },
  { title: "24/7 support", desc: "real humans, 7-min average reply time" },
];

export function FacebookViewsHero() {
  const [tab, setTab] = useState<(typeof SERVICE_TABS)[number]["id"]>("views");
  const [selected, setSelected] = useState(4); // 10K popular tier
    ...
    <section style={{ background: "var(--uv-bg-lavender)", paddingTop: 40, paddingBottom: 96 }}>
      <div className="container">
        ...
        >
          ...
          <a href="/buy-facebook-views" style={{ color: "var(--uv-fg-3)" }}>
            Facebook
          </a>
          <span style={{ opacity: 0.4 }}>›</span>
        ...
        >
          Buy Facebook Views <span style={{ color: "var(--uv-fg-3)", fontWeight: 500 }}>—</span>{" "}
          <span className="grad-text">that warm the Facebook algorithm</span>
        </h1>
        <p
          style={{
            fontSize: 17,
        ...
        >
          Buy Facebook Views for any public video — feed, Reels, or Watch. Real watch sessions,
          drip-fed for a natural retention curve, no password needed.
        </p>

        <div className="live-pill">
          <span className="live-dot" />
          <span>
            <strong>647 live users</strong> on this page right now
          </span>
        </div>
          ...
          <div className="svc-builder">
            ...
            <div className="pkg-card">
              ...
              <label className="pkg-url-wrap">
                ...
                <div style={{ flex: 1 }}>
                  <div className="pkg-url-label">FACEBOOK VIDEO LINK</div>
                  <input
...
export function FacebookViewsFaq() {
