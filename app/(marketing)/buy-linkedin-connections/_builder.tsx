...
const SIDE_BENEFITS = [
  { title: "Real profiles", desc: "connections from active, complete LinkedIn accounts" },
  { title: "Starts in 30 min", desc: "drip-fed over 24-96 hours for a natural curve" },
  { title: "30-day refill", desc: "free top-up if any drop in the first month" },
  { title: "24/7 support", desc: "real humans, 7-min average reply time" },
];

export function LinkedInConnectionsHero() {
  const [tab] = useState<(typeof SERVICE_TABS)[number]["id"]>("connections");
    ...
    <section style={{ background: "var(--uv-bg-lavender)", paddingTop: 40, paddingBottom: 96 }}>
      <div className="container">
        ...
        >
          ...
          <a href="/buy-linkedin-connections" style={{ color: "var(--uv-fg-3)" }}>
            LinkedIn
          </a>
          <span style={{ opacity: 0.4 }}>›</span>
          <span style={{ color: "var(--uv-fg-1)", fontWeight: 600 }}>Connections</span>
        </nav>
        ...
        >
          Buy LinkedIn Connections <span style={{ color: "var(--uv-fg-3)", fontWeight: 500 }}>—</span>{" "}
          <span className="grad-text">that open every B2B door</span>
        </h1>
        <p
          style={{
            fontSize: 17,
        ...
        >
          Buy LinkedIn Connections from real, active profiles. 30-day refill guarantee, no password
          needed, drip-fed to keep your growth pattern inside LinkedIn&apos;s normal range for an
          active professional.
        </p>
          ...
          <div className="svc-builder">
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                ...
                <div>
                  ...
                  <div className="prem-sub">
                    Aged executive profiles · faster delivery · lifetime refill
                  </div>
                </div>
              </div>
              <button
            ...
            <div className="pkg-card">
              ...
              <div className="pkg-trust">
                ...
                <span>
                  <Zap size={14} color="var(--uv-pink)" /> 30-min delivery
                </span>
                <span>
...
export function LinkedInConnectionsFaq() {
