...
const SIDE_BENEFITS = [
  { title: "Real users", desc: "reactions from real, active LinkedIn accounts" },
  { title: "Starts in 10 min", desc: "drip-fed naturally over the next few hours" },
  { title: "Money-back", desc: "refund if we miss the count or speed" },
  { title: "24/7 support", desc: "real humans, 7-min average reply time" },
];

export function LinkedInLikesHero() {
  ...
  return (
    <section style={{ background: "var(--uv-bg-lavender)", paddingTop: 40, paddingBottom: 96 }}>
      <div className="container">
        ...
        >
          Buy LinkedIn Likes <span style={{ color: "var(--uv-fg-3)", fontWeight: 500 }}>—</span>{" "}
          <span className="grad-text">that push your post into more professional feeds</span>
        </h1>
        <p
          style={{
            fontSize: 17,
        ...
        >
          Buy LinkedIn Likes from real, active professional accounts. Money-back guarantee, no
          password needed, drip-fed naturally for a safe, organic look.
        </p>
...
export function LinkedInLikesFaq() {
