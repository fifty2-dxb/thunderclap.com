...
const URL_PATH = "/twitter/retweets";
...
const RELATED = [
  ...
  { label: "Buy Twitter / X Likes", desc: "From $0.69", Icon: Heart, href: "/twitter/likes" },
  { label: "Buy Instagram Followers", desc: "From $0.49", Icon: Megaphone, href: "/instagram/followers" },
];
