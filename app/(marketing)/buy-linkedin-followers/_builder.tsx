...
const SIDE_BENEFITS = [
  { title: "Real profiles", desc: "followers from real LinkedIn profiles with work history" },
  { title: "Starts in 5 min", desc: "drip-fed over 24-96 hours for a natural curve" },
...
export function LinkedInFollowersHero() {
  const [tab] = useState<(typeof SERVICE_TABS)[number]["id"]>("followers");
  ...
  return (
    <section style={{ background: "var(--uv-bg-lavender)", paddingTop: 40, paddingBottom: 96 }}>
      <div className="container">
        ...
        >
          Buy LinkedIn Followers <span style={{ color: "var(--uv-fg-3)", fontWeight: 500 }}>—</span>{" "}
          <span className="grad-text">that build your professional authority</span>
        </h1>
        <p
          style={{
            fontSize: 17,
        ...
        >
          Buy LinkedIn Followers from real, active professional profiles. 30-day refill guarantee,
          no password needed, drip-fed to keep your growth pattern inside LinkedIn&apos;s normal
          range.
        </p>
        ...
        <div className="live-pill">
          ...
          <span>
            <strong>284 live users</strong> on this page right now
          </span>
        </div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                ...
                <div>
                  ...
                  <div className="prem-sub">
                    Aged & senior-title profiles · faster delivery · lifetime refill
                  </div>
                </div>
              </div>
              <button
...
export function LinkedInFollowersFaq() {
