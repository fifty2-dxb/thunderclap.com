...
const URL_PATH = "/youtube/subscribers";
...
const RELATED = [
  { label: "Buy YouTube Views", desc: "From $1.99", Icon: Play, href: "/youtube/views" },
  { label: "Buy TikTok Followers", desc: "From $0.49", Icon: Users, href: "/tiktok/followers" },
  { label: "Buy Instagram Followers", desc: "From $0.99", Icon: Heart, href: "/instagram/followers" },
];
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "YouTube", item: `${SITE_URL}/youtube/subscribers` },
