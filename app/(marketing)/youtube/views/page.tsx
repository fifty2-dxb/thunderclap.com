...
const RELATED = [
  { label: "Buy YouTube Subscribers", desc: "From $2.05", Icon: Users, href: "/youtube/subscribers" },
  { label: "Buy TikTok Views", desc: "From $0.79", Icon: Play, href: "/tiktok/views" },
  { label: "Buy Instagram Views", desc: "From $0.99", Icon: Heart, href: "/instagram/views" },
];
