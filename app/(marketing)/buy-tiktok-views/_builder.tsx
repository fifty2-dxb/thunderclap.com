...
const PACKAGES = [
  { qty: 1000, price: 0.79, save: 0 },
  { qty: 2500, price: 1.49, save: 0 },
  { qty: 5000, price: 2.49, save: 0 },
  { qty: 10000, price: 4.49, save: 0 },
  { qty: 25000, price: 8.99, save: 25, popular: true },
  { qty: 50000, price: 14.99, save: 28 },
  { qty: 100000, price: 24.99, save: 35 },
  { qty: 250000, price: 54.99, save: 38 },
  { qty: 500000, price: 99.99, save: 42 },
  { qty: 1000000, price: 179.99, save: 45 },
  { qty: 2500000, price: 399.99, save: 48 },
  { qty: 5000000, price: 749.99, save: 50 },
  { qty: 10000000, price: 1399.99, save: 50 },
  { qty: 25000000, price: 2999.99, save: 50 },
] as const;

const SIDE_BENEFITS = [
  { title: "Real watch time", desc: "views from real TikTok users, not bots" },
...
export function TikTokViewsHero() {
  const [tab, setTab] = useState<(typeof SERVICE_TABS)[number]["id"]>("views");
  const [selected, setSelected] = useState(4); // 25K popular tier
  ...
  return (
    <section style={{ background: "var(--uv-bg-lavender)", paddingTop: 40, paddingBottom: 96 }}>
      <div className="container">
        ...
        >
          Buy TikTok Views <span style={{ color: "var(--uv-fg-3)", fontWeight: 500 }}>—</span>{" "}
          <span className="grad-text">that push you onto the FYP</span>
        </h1>
        <p
          style={{
            fontSize: 17,
        ...
        >
          Buy TikTok Views for any video. Real watch sessions, drip-fed for a natural curve, no
          password needed.
        </p>
        ...
        <div className="live-pill">
          ...
          <span>
            <strong>812 live users</strong> on this page right now
          </span>
        </div>
          ...
          <div className="svc-builder">
            ...
            <div className="pkg-card">
              ...
              <label className="pkg-url-wrap">
                ...
                <div style={{ flex: 1 }}>
                  <div className="pkg-url-label">TIKTOK VIDEO LINK</div>
                  <input
...
export function TikTokViewsFaq() {
