...
const PACKAGES = [
  ...
  { qty: 5000, price: 16.99, regular: 21.24 },
  { qty: 10000, price: 26.99, regular: 33.74, popular: true },
  { qty: 25000, price: 54.99, regular: 68.74 },
  { qty: 50000, price: 79.99, regular: 99.99 },
] as const;
  ...
  return (
    <section style={{ background: "var(--uv-bg-lavender)", paddingTop: 40, paddingBottom: 96 }}>
      <div className="container">
        ...
        >
          Buy Instagram Views <span style={{ color: "var(--uv-fg-3)", fontWeight: 500 }}>—</span>{" "}
