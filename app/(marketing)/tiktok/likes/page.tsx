...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Buy TikTok Likes — Real, Fast, Safe · Thunderclap",
    description:
      "Real TikTok likes from active users. Delivery starts in 5 minutes, drip-fed for a safe organic look. 30-day refill guarantee.",
    url: CANONICAL,
  ...
  twitter: {
    ...
    title: "Buy TikTok Likes — Real, Fast, Safe · Thunderclap",
    description:
      "Real TikTok likes, delivered in minutes. 30-day refill guarantee. No password required.",
  },
};
...
const BENEFITS = [
  {
    ...
    body: "Likes from active TikTok accounts that don't drop. The engagement looks indistinguishable from organic For You Page traffic.",
  },
  {
    Icon: Zap,
    title: "Algorithmic velocity",
    body: "The TikTok algorithm reads early engagement velocity to decide who sees your video next. We deliver fast so your first-hour signal is strong.",
  },
  {
    Icon: TrendingUp,
    title: "More FYP placements",
    body: "Videos with high like-counts move from small test pools into wider For You Page distribution — that's where real, compounding growth begins.",
  },
];
...
const PERSONAS = [
  {
    ...
    title: "Break past the first viral wall.",
    body: "Most new TikToks die in the 200-view test pool. A strong like-count in the first hour tells the algorithm your video deserves a bigger audience and pushes it into the next FYP tier.",
    img: "https://images.unsplash.com/photo-1611162616475-46b635cb6868?auto=format&fit=crop&w=900&q=80",
  },
  {
    eyebrow: "FOR BRANDS",
    title: "Validate product launch videos fast.",
    body: "Launch creatives need social proof from minute one. A healthy like-count on your launch TikTok becomes the trust signal that turns ad clicks and FYP browsers into paying customers.",
  ...
  },
  {
    ...
    body: "Reporting weeks shouldn't be a gamble. Top up underperforming videos to keep engagement-rate KPIs above the benchmark your clients signed off on — across every account you manage.",
...
const REVIEWS = [
  {
    stars: 5,
    text: "Bought 5K likes on a launch TikTok and woke up to it sitting on the FYP. Like-count gave the algorithm the push it needed.",
    name: "Sofia Alvarez",
  ...
  {
    stars: 5,
    text: "Used the TikTok Likes package for our product drop video. Delivery was fast, retention is solid, and the conversions followed.",
    name: "Marcus Chen",
  ...
  {
    stars: 5,
    text: "Tried three other TikTok like providers before Thunderclap. This is the only one where the likes stuck and the FYP reach actually moved.",
    name: "Priya Sharma",
    role: "Beauty creator",
...
const productJsonLd = {
  ...
  name: "TikTok Likes",
  description:
    "Real TikTok likes from active accounts. Delivery starts in 5 minutes. 30-day refill guarantee. No password required.",
      ...
      <section style={{ padding: "96px 0 32px" }}>
        <div className="container">
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            ...
            >
              Likes are the fastest <span className="grad-text">signal</span> TikTok trusts.
            </h2>
          </div>
      ...
      <section style={{ padding: "32px 0 80px" }}>
        <div className="container">
          <div className="coral-band">
            ...
            <p>
              Pick a package, paste your video URL, and watch your likes climb within the hour.
            </p>
            <div
