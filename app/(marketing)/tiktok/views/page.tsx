...
import { TikTokViewsHero, TikTokViewsFaq } from "./_builder";
import { TT_FAQS } from "./_faqs";

const URL_PATH = "/tiktok/views";
const CANONICAL = `${SITE_URL}${URL_PATH}`;

export const metadata: Metadata = {
  title: "Buy TikTok Views — Real, Fast, Safe · Thunderclap",
  description:
    "Buy real TikTok views for any video. Delivery starts in 5 minutes. 30-day refill guarantee. No password required. Trusted by 200,000+ creators.",
  alternates: { canonical: CANONICAL },
  openGraph: {
    title: "Buy TikTok Views — Real, Fast, Safe · Thunderclap",
    description:
      "Real TikTok views from active users. Delivery starts in 5 minutes, drip-fed for a safe organic curve. 30-day refill guarantee.",
    url: CANONICAL,
  ...
  twitter: {
    ...
    title: "Buy TikTok Views — Real, Fast, Safe · Thunderclap",
    description:
      "Real TikTok views, delivered in minutes. 30-day refill guarantee. No password required.",
  },
};
...
const BENEFITS = [
  {
    ...
    body: "Every view comes from a real TikTok user opening your video — not a botnet. That's why they stick, count toward your metrics, and lift your standing in the TikTok ranking algorithm.",
  },
  {
    Icon: Zap,
    title: "FYP-friendly velocity",
    body: "Delivery starts in 5 minutes and drips over 1-4 hours. TikTok reads early watch velocity as the strongest quality signal there is, and pushes the video onto millions of new For You feeds.",
  },
  {
    Icon: TrendingUp,
    title: "Bigger reach, more followers",
    body: "TikToks with high view counts compound — strangers binge them, share them, and follow you afterwards. View count is the social proof that converts a scroll into a follow on TikTok.",
  },
];
...
const PERSONAS = [
  {
    ...
    title: "Break onto the FYP.",
    body: "The first 24 hours of a TikTok decide its ceiling. Front-loading view count tells the algorithm your video is performing — and TikTok rewards you with placement on millions of new For You feeds.",
  ...
  },
  {
    ...
    body: "When prospects land on your product TikTok, view count is the first credibility cue. A video with 100K views converts at 3× the rate of the same video with 1,200. Anchor the launch.",
  ...
  },
  {
    ...
    body: "Client briefs come with TikTok view-count KPIs. Use Thunderclap to top up under-performing posts before reporting day — without disclosing it to the platform or risking the account.",
...
const COMPARE_ROWS = [
  ...
  { label: "Counts toward TikTok monetization metrics", us: true, them: false },
...
const REVIEWS = [
  {
    stars: 5,
    text: "Used Thunderclap on a TikTok launch — pushed it to 120K real views in the first day and the FYP picked it up for two weeks straight. Wild ROI.",
    name: "Jordan Reyes",
    role: "Music creator",
  ...
  {
    stars: 5,
    text: "My product TikTok was stuck at 1.4K views for a week. One order, three hours, 28K views — and the FYP took over from there. Orders followed.",
    name: "Camille Dubois",
  ...
  {
    stars: 5,
    text: "I run TikTok ads for clients and use Thunderclap to warm up the organic video first. CPM dropped 40% because the FYP-style social proof was already there.",
    name: "Ahmed Khan",
...
const RELATED = [
  { label: "Buy TikTok Followers", desc: "From $0.49", Icon: Users, href: "/tiktok/followers" },
  { label: "Buy TikTok Likes", desc: "From $0.59", Icon: Heart, href: "/tiktok/likes" },
...
const productJsonLd = {
  ...
  name: "TikTok Views",
  description:
    "Real TikTok views for any public video. Delivery starts in 5 minutes. 30-day refill guarantee. No password required.",
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "TikTok", item: `${SITE_URL}/tiktok/followers` },
      ...
      <section style={{ padding: "96px 0 32px" }}>
        <div className="container">
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            ...
            >
              Views are the loudest <span className="grad-text">signal</span> a TikTok can send.
            </h2>
          </div>
      ...
      <section style={{ padding: "64px 0", background: "var(--uv-bg-lavender)" }}>
        <div className="container">
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            ...
            >
              Built for every kind of TikTok video.
            </h2>
          </div>
      ...
      <section style={{ padding: "32px 0 80px" }}>
        <div className="container">
          <div className="coral-band">
            ...
            <h2>Ready to push your TikTok?</h2>
            <p>
