...
const SERVICES: Service[] = [
  ...
  { platformId: "youtube",   platformName: "YouTube",   service: "Subscribers", href: "/buy-youtube-subscribers", price: "$2.05", brand: YouTubeBrand, bg: "#FF0000" },
  { platformId: "youtube",   platformName: "YouTube",   service: "Views",     href: "/buy-youtube-views",       price: "$1.99", brand: YouTubeBrand, bg: "#FF0000" },
  { platformId: "facebook",  platformName: "Facebook",  service: "Followers", href: "/buy-facebook-followers",  price: "$0.59", brand: FacebookBrand, bg: "#1877F2" },
  { platformId: "facebook",  platformName: "Facebook",  service: "Likes",     href: "/buy-facebook-likes",      price: "$0.49", brand: FacebookBrand, bg: "#1877F2" },
  { platformId: "facebook",  platformName: "Facebook",  service: "Views",     href: "/buy-facebook-views",      price: "$0.79", brand: FacebookBrand, bg: "#1877F2" },
  { platformId: "twitter",   platformName: "Twitter / X", service: "Followers", href: "/buy-twitter-followers", price: "$1.99", brand: TwitterBrand, bg: "#000" },
  { platformId: "twitter",   platformName: "Twitter / X", service: "Likes",     href: "/buy-twitter-likes",     price: "$0.99", brand: TwitterBrand, bg: "#000" },
  { platformId: "twitter",   platformName: "Twitter / X", service: "Retweets",  href: "/buy-twitter-retweets",  price: "$0.99", brand: TwitterBrand, bg: "#000" },
];
